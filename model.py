...
# this notebook uses 3 cnn blocks for one identity mapping
...
# TODO: maki, this is equation 2, in paper page 3;
# TODO: maki, this is same with identity_block and the only difference is the shortcut
